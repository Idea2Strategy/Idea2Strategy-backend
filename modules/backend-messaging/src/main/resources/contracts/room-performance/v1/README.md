...
- `evaluation-commands.valid.json`: initialize, start, end, and the mutually exclusive continue-as-private/stop command examples with their locked half-open evaluation boundaries.
